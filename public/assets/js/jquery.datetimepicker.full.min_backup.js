            ...
            formatDate: function (e, t) {
                ...
                if (e instanceof Date) {
                    for (n = t.length, a = 0; n > a; a++)
                        "S" !== (i = t.charAt(a)) &&
                            "\\" !== i &&
                            (a > 0 && "\\" === t.charAt(a - 1) ? (u += i) : ((o = s.parseFormat(i, e)), a !== n - 1 && s.intParts.test(i) && "S" === t.charAt(a + 1) && ((r = parseInt(o) || 0), (o += s.dateSettings.ordinal(r))), (u += o)));
                    return u;
                }
                return "";
            },
            ...
            return this.each(function () {
                ...
                "hide" !== a
                    ? (e(this).hasClass("xdsoft_scroller_box") ||
                          ...
                          s
                              .on("touchstart.xdsoft_scroller mousedown.xdsoft_scroller", function (r) {
                                  n || u.trigger("resize_scroll.xdsoft_scroller", [a]),
                                      ...
                                      "mousedown" === r.type || "touchstart" === r.type
                                          ? (t.ownerDocument && e(t.ownerDocument.body).addClass("xdsoft_noselect"),
                                            ...
                                            e(t.ownerDocument.body).on("mousemove.xdsoft_scroller", D))
                                  ...
                                  (n = u[0].clientHeight),
                                      ...
                                      d > 1
                                          ...
                                          : (s.show(),
                                            ...
                                            !0 !== a && u.trigger("scroll_element.xdsoft_scroller", [t || Math.abs(parseInt(r.css("marginTop"), 10)) / (o - n)]));
                              }),
                    ...
                    function i() {
                        ...
                        return (
                            C.startDate
                                ...
                                ? ((t = A.strToDateTime(t)), C.yearOffset && (t = new Date(t.getFullYear() - C.yearOffset, t.getMonth(), t.getDate(), t.getHours(), t.getMinutes(), t.getSeconds(), t.getMilliseconds())))
                                : C.defaultDate && ((t = A.strToDateTime(C.defaultDate)), C.defaultTime && ((e = A.strtotime(C.defaultTime)), t.setHours(e.getHours()), t.setMinutes(e.getMinutes()))),
                            ...
                            "string" === e.type(t.mask) &&
                                ...
                                a.on("paste.xdsoft", function (r) {
                                    ...
                                    return (
                                        ...
                                        (u += i.length),
                                        n(t.mask, s) ? ((this.value = s), o(this, u)) : "" === e.trim(s) ? (this.value = t.mask.replace(/[0-9]/g, "_")) : a.trigger("error_input.xdsoft"),
                                        r.preventDefault(),
                                        !1
                                    );
                                }),
                    ...
                    C.id && j.attr("id", C.id),
                        ...
                        I.find(".xdsoft_month,.xdsoft_year").on("touchstart mousedown.xdsoft", function (t) {
                            var a,
                                ...
                                s = n.is(":visible");
                            for (
                                I.find(".xdsoft_select").hide(), A.currentTime && (o = A.currentTime[e(this).hasClass("xdsoft_month") ? "getMonth" : "getFullYear"]()), n[s ? "hide" : "show"](), a = n.find("div.xdsoft_option"), r = 0;
                    ...
                    I.find(".xdsoft_select")
                        ...
                        .on("touchend mousedown.xdsoft", ".xdsoft_option", function () {
                            if (!this.touchMoved) {
                                ...
                                A && A.currentTime && A.currentTime[e(this).parent().parent().hasClass("xdsoft_monthselect") ? "setMonth" : "setFullYear"](e(this).data("value")),
                                    e(this).parent().parent().hide(),
                                    j.trigger("xchange.xdsoft"),
                                    C.onChangeMonth && e.isFunction(C.onChangeMonth) && C.onChangeMonth.call(j, A.currentTime, j.data("input")),
                                    t !== A.currentTime.getFullYear() && e.isFunction(C.onChangeYear) && C.onChangeYear.call(j, A.currentTime, j.data("input"));
                            }
                        }),
                        (j.getValue = function () {
                        ...
                        (j.setOptions = function (n) {
                            ...
                            (C = e.extend(!0, {}, C, n)),
                                    ...
                                    e.each(n.highlightedPeriods, function (a, n) {
                                        ...
                                        for (; i <= s; )
                                            (d = new t(i, u, c)),
                                                ...
                                                void 0 !== o[l] ? (f = o[l].desc) && f.length && d.desc && d.desc.length && (o[l].desc = f + "\n" + d.desc) : (o[l] = d);
                                    }),
                                    (C.highlightedDates = e.extend(!0, [], o))),
                                ...
                                C.inline && ((U = !0), j.addClass("xdsoft_inline"), a.after(j).hide()),
                                ...
                                C.value && (A.setCurrentTime(C.value), a && a.val && a.val(A.str)),
                                ...
                                C.minDate && /^[\+\-](.*)$/.test(C.minDate) && (C.minDate = r.formatDate(A.strToDateTime(C.minDate), C.formatDate)),
                                C.maxDate && /^[\+\-](.*)$/.test(C.maxDate) && (C.maxDate = r.formatDate(A.strToDateTime(C.maxDate), C.formatDate)),
                                C.minDateTime && /^\+(.*)$/.test(C.minDateTime) && (C.minDateTime = A.strToDateTime(C.minDateTime).dateFormat(C.formatDate)),
                                C.maxDateTime && /^\+(.*)$/.test(C.maxDateTime) && (C.maxDateTime = A.strToDateTime(C.maxDateTime).dateFormat(C.formatDate)),
                                    ...
                                    a.off("blur.xdsoft").on("blur.xdsoft", function () {
                                        if (C.allowBlank && (!e.trim(e(this).val()).length || ("string" == typeof C.mask && e.trim(e(this).val()) === C.mask.replace(/[0-9]/g, "_")))) e(this).val(null), j.data("xdsoft_datetime").empty();
                                            ...
                                            if (t) e(this).val(r.formatDate(t, C.format));
                                                ...
                                                !C.datepicker && C.timepicker && a >= 0 && a < 24 && n >= 0 && n < 60
                                                    ? e(this).val(
                                                          [a, n]
                                                              .map(function (e) {
                                                                  return e > 9 ? e : "0" + e;
                        ...
                        (A = new (function () {
                            ...
                            (t.now = function (e) {
                                var a,
                                    ...
                                    n = new Date();
                                return (
                                    !e && C.defaultDate && ((a = t.strToDateTime(C.defaultDate)), n.setFullYear(a.getFullYear()), n.setMonth(a.getMonth()), n.setDate(a.getDate())),
                                    n.setFullYear(n.getFullYear()),
                                    !e && C.defaultTime && ((r = t.strtotime(C.defaultTime)), n.setHours(r.getHours()), n.setMinutes(r.getMinutes()), n.setSeconds(r.getSeconds()), n.setMilliseconds(r.getMilliseconds())),
                                    n
                                );
                            }),
                                ...
                                (t.setCurrentTime = function (e, a) {
                                    "string" == typeof e ? (t.currentTime = t.strToDateTime(e)) : t.isValidDate(e) ? (t.currentTime = e) : e || a || !C.allowBlank || C.inline ? (t.currentTime = t.now()) : (t.currentTime = null),
                                        j.trigger("xchange.xdsoft");
                                }),
                                (t.empty = function () {
                                    t.currentTime = null;
                                ...
                                (t.nextMonth = function () {
                                    ...
                                    return (
                                        12 === r && (t.currentTime.setFullYear(t.currentTime.getFullYear() + 1), (r = 0)),
                                        (a = t.currentTime.getFullYear()),
                                        t.currentTime.setDate(Math.min(new Date(t.currentTime.getFullYear(), r + 1, 0).getDate(), t.currentTime.getDate())),
                                        t.currentTime.setMonth(r),
                                        C.onChangeMonth && e.isFunction(C.onChangeMonth) && C.onChangeMonth.call(j, A.currentTime, j.data("input")),
                                        a !== t.currentTime.getFullYear() && e.isFunction(C.onChangeYear) && C.onChangeYear.call(j, A.currentTime, j.data("input")),
                                        j.trigger("xchange.xdsoft"),
                                        r
                                    );
                                }),
                                ...
                                (t.strToDateTime = function (e) {
                                    ...
                                    return e && e instanceof Date && t.isValidDate(e)
                                        ? e
                                        : ((o = /^([+-]{1})(.*)$/.exec(e)) && (o[2] = r.parseDate(o[2], C.formatDate)),
                                          o && o[2] ? ((a = o[2].getTime() - 6e4 * o[2].getTimezoneOffset()), (n = new Date(t.now(!0).getTime() + parseInt(o[1] + "1", 10) * a))) : (n = e ? r.parseDate(e, C.format) : t.now()),
                                ...
                                (t.str = function () {
                                    var e = C.format;
                                    return (
                                        C.yearOffset && (e = (e = e.replace("Y", t.currentTime.getFullYear() + C.yearOffset)).replace("y", String(t.currentTime.getFullYear() + C.yearOffset).substring(2, 4))), r.formatDate(t.currentTime, e)
                                    );
                                }),
                        ...
                        I.find(".xdsoft_today_button")
                            ...
                            .on("dblclick.xdsoft", function () {
                                ...
                                (r = new Date(r.getFullYear(), r.getMonth(), r.getDate())),
                                    ...
                                    r < (e = new Date(e.getFullYear(), e.getMonth(), e.getDate())) ||
                        ...
                        L.find(".xdsoft_prev,.xdsoft_next").on("touchend mousedown.xdsoft", function () {
                            ...
                            !(function e(o) {
                                ...
                                t.hasClass(C.next) && s - i - C.timeHeightInTimePicker >= u
                                    ? R.css("marginTop", "-" + (u + C.timeHeightInTimePicker) + "px")
                                    : t.hasClass(C.prev) && u - C.timeHeightInTimePicker >= 0 && R.css("marginTop", "-" + (u - C.timeHeightInTimePicker) + "px"),
                                    E.trigger("scroll_element.xdsoft_scroller", [Math.abs(parseInt(R[0].style.marginTop, 10) / (s - i))]),
                                    (n = n > 10 ? 10 : n - 10),
                        ...
                        j
                                    ...
                                    (u = setTimeout(function () {
                                        ...
                                        for (
                                            var t,
                                                ...
                                                h,
                                                g = "",
                                                p = new Date(A.currentTime.getFullYear(), A.currentTime.getMonth(), 1, 12, 0, 0),
                                                D = 0,
                                                v = A.now(),
                                                y = !1,
                                                b = !1,
                                        ...
                                        (g += "</tr></thead>"),
                                            (g += "<tbody>"),
                                            !1 !== C.maxDate && ((y = A.strToDate(C.maxDate)), (y = new Date(y.getFullYear(), y.getMonth(), y.getDate(), 23, 59, 59, 999))),
                                            !1 !== C.minDate && ((b = A.strToDate(C.minDate)), (b = new Date(b.getFullYear(), b.getMonth(), b.getDate()))),
                                            !1 !== C.minDateTime && ((k = A.strToDate(C.minDateTime)), (k = new Date(k.getFullYear(), k.getMonth(), k.getDate(), k.getHours(), k.getMinutes(), k.getSeconds()))),
                                            !1 !== C.maxDateTime && ((x = A.strToDate(C.maxDateTime)), (x = new Date(x.getFullYear(), x.getMonth(), x.getDate(), x.getHours(), x.getMinutes(), x.getSeconds())));
                                        var w;
                                        for (
                                            !1 !== x && (w = 31 * (12 * x.getFullYear() + x.getMonth()) + x.getDate());
                                            ...
                                            (T = []),
                                                ...
                                                (h = ""),
                                                T.push("xdsoft_date"),
                                                (c = C.beforeShowDay && e.isFunction(C.beforeShowDay.call) ? C.beforeShowDay.call(j, p) : null),
                                                C.allowDateRe && "[object RegExp]" === Object.prototype.toString.call(C.allowDateRe) && (C.allowDateRe.test(r.formatDate(p, C.formatDate)) || T.push("xdsoft_disabled")),
                                                C.allowDates && C.allowDates.length > 0 && -1 === C.allowDates.indexOf(r.formatDate(p, C.formatDate)) && T.push("xdsoft_disabled");
                                            var O = 31 * (12 * p.getFullYear() + p.getMonth()) + p.getDate();
                                            ((!1 !== y && p > y) || (!1 !== k && p < k) || (!1 !== b && p < b) || (!1 !== x && O > w) || (c && !1 === c[0])) && T.push("xdsoft_disabled"),
                                                -1 !== C.disabledDates.indexOf(r.formatDate(p, C.formatDate)) && T.push("xdsoft_disabled"),
                                                -1 !== C.disabledWeekDays.indexOf(s) && T.push("xdsoft_disabled"),
                                                a.is("[disabled]") && T.push("xdsoft_disabled"),
                                                c && "" !== c[1] && T.push(c[1]),
                                                A.currentTime.getMonth() !== l && T.push("xdsoft_other_month"),
                                                (C.defaultSelect || j.data("changed")) && r.formatDate(A.currentTime, C.formatDate) === r.formatDate(p, C.formatDate) && T.push("xdsoft_current"),
                                                r.formatDate(v, C.formatDate) === r.formatDate(p, C.formatDate) && T.push("xdsoft_today"),
                                                (0 !== p.getDay() && 6 !== p.getDay() && -1 === C.weekends.indexOf(r.formatDate(p, C.formatDate))) || T.push("xdsoft_weekend"),
                                                void 0 !== C.highlightedDates[r.formatDate(p, C.formatDate)] &&
                                                    ((i = C.highlightedDates[r.formatDate(p, C.formatDate)]), T.push(void 0 === i.style ? "xdsoft_highlighted_default" : i.style), (h = void 0 === i.desc ? "" : i.desc)),
                                                C.beforeShowDay && e.isFunction(C.beforeShowDay) && T.push(C.beforeShowDay(p)),
                                                S && ((g += "<tr>"), (S = !1), C.weeks && (g += "<th>" + f + "</th>")),
                                                (g +=
                                                    '<td data-date="' +
                                                    u +
                                                    '" data-month="' +
                                                    ...
                                                    u +
                                                    "</div></td>"),
                                                p.getDay() === C.dayOfWeekStartPrev && ((g += "</tr>"), (S = !0)),
                                                p.setDate(u + 1);
                                        }
                                        (g += "</tbody></table>"),
                                            N.html(g),
                                            I.find(".xdsoft_label span").eq(0).text(C.i18n[o].months[A.currentTime.getMonth()]),
                                        ...
                                        if (
                                            ((m = function (t, n) {
                                                ...
                                                var u = 60 * t + n;
                                                (a.is("[disabled]") || u >= _ || u < W) && T.push("xdsoft_disabled"),
                                                    (o = new Date(A.currentTime)).setHours(parseInt(A.currentTime.getHours(), 10)),
                                                    s || o.setMinutes(Math[C.roundTime](A.currentTime.getMinutes() / C.step) * C.step),
                                                    (C.initTime || C.defaultSelect || j.data("changed")) &&
                                                        o.getHours() === parseInt(t, 10) &&
                                                        ((!s && C.step > 59) || o.getMinutes() === parseInt(n, 10)) &&
                                                        (C.defaultSelect || j.data("changed") ? T.push("xdsoft_current") : C.initTime && T.push("xdsoft_init_time")),
                                                    parseInt(v.getHours(), 10) === parseInt(t, 10) && parseInt(v.getMinutes(), 10) === parseInt(n, 10) && T.push("xdsoft_today"),
                                                    (M += '<div class="xdsoft_time ' + T.join(" ") + '" data-hour="' + t + '" data-minute="' + n + '">' + r.formatDate(i, C.formatTime) + "</div>");
                                            }),
                            ...
                            .on("afterOpen.xdsoft", function () {
                                if (C.timepicker) {
                                    var e, t, a, r;
                                    R.find(".xdsoft_current").length ? (e = ".xdsoft_current") : R.find(".xdsoft_init_time").length && (e = ".xdsoft_init_time"),
                                        e
                                            ? ((t = E[0].clientHeight),
                                              (a = R[0].offsetHeight) - t < (r = R.find(e).index() * C.timeHeightInTimePicker + 1) && (r = a - t),
                                              E.trigger("scroll_element.xdsoft_scroller", [parseInt(r, 10) / (a - t)]))
                        ...
                        N.on("touchend click.xdsoft", "td", function (t) {
                            ...
                            n.setDate(1),
                                ...
                                a.val(A.str()),
                                C.onSelectDate && e.isFunction(C.onSelectDate) && C.onSelectDate.call(j, A.currentTime, j.data("input"), t),
                                j.data("changed", !0),
                                j.trigger("xchange.xdsoft"),
                                j.trigger("changedatetime.xdsoft"),
                                (d > 1 || !0 === C.closeOnDateSelect || (!1 === C.closeOnDateSelect && !C.timepicker)) && !C.inline && j.trigger("close.xdsoft"),
                                setTimeout(function () {
                                    d = 0;
                                }, 200);
                        }),
                            ...
                            .on("touchend click.xdsoft", "div", function (t) {
                                if (!this.touchMoved) {
                                    ...
                                    r.setHours(a.data("hour")),
                                        ...
                                        C.onSelectTime && e.isFunction(C.onSelectTime) && C.onSelectTime.call(j, A.currentTime, j.data("input"), t),
                                        j.data("changed", !0),
                                        j.trigger("xchange.xdsoft"),
                                        j.trigger("changedatetime.xdsoft"),
                                        !0 !== C.inline && !0 === C.closeOnTimeSelect && j.trigger("close.xdsoft");
                                }
                            }),
                        ...
                        a.on("mousewheel.xdsoft", function (e) {
                            return (
                                ...
                                (!C.datepicker && C.timepicker
                                    ? ((P = R.find(".xdsoft_current").length ? R.find(".xdsoft_current").eq(0).index() : 0) + e.deltaY >= 0 && P + e.deltaY < R.children().length && (P += e.deltaY),
                                      R.children().eq(P).length && R.children().eq(P).trigger("mousedown"),
                                      !1)
                                    : C.datepicker && !C.timepicker
                                    ? (z.trigger(e, [e.deltaY, e.deltaX, e.deltaY]), a.val && a.val(A.str()), j.trigger("changedatetime.xdsoft"), !1)
                                    : void 0)
                            );
                        }),
                        j
                        ...
                        (Y = function () {
                            ...
                            if (
                                ...
                                C.ownerDocument.documentElement.clientWidth - t.left < z.parent().outerWidth(!0))
                            ) {
                                var h = z.parent().outerWidth(!0) - a.offsetWidth;
                                n -= h;
                            }
                            "rtl" === u.parent().css("direction") && (n -= j.outerWidth() - u.outerWidth()),
                                C.fixed
                                    ...
                                    : ((s = !1),
                                      ...
                                      s ? ((o = "fixed"), r + j.outerHeight() > c + m ? ((l = "bottom"), (r = c + m - t.top)) : (r -= m)) : r + j[0].offsetHeight > c + m && (r = t.top - j[0].offsetHeight + 1),
                                      r < 0 && (r = 0),
                        ...
                        j
                            .on("open.xdsoft", function (t) {
                                var a = !0;
                                C.onShow && e.isFunction(C.onShow) && (a = C.onShow.call(j, A.currentTime, j.data("input"), t)),
                                    !1 !== a &&
                                        (j.show(),
                                        Y(),
                                        e(C.contentWindow).off("resize.xdsoft", Y).on("resize.xdsoft", Y),
                            ...
                            .on("close.xdsoft", function (t) {
                                var a = !0;
                                I.find(".xdsoft_month,.xdsoft_year").find(".xdsoft_select").hide(),
                                    C.onClose && e.isFunction(C.onClose) && (a = C.onClose.call(j, A.currentTime, j.data("input"), t)),
                        ...
                        a
                            ...
                            .on("keydown.xdsoft", function (t) {
                                ...
                                return -1 !== [p].indexOf(r) && C.enterLikeTab
                                    ? ((a = e("input:visible,textarea:visible,button:visible,a:visible")), j.trigger("close.xdsoft"), a.eq(a.index(this) + 1).focus(), !1)
                                    : -1 !== [T].indexOf(r)
