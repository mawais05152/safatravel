<div class="container-xxl motiff best-umrah-deals" style="margin-top: -25px;">
    <div class="text-center wow fadeInUp" data-wow-delay="0.1s" style="margin-top: 6%; margin-bottom: 3%;">
        <h6 class="text-center text-primary px-3">All-Inclusive</h6>
        <h2 class="Best deals ">Best Umrah Deals</h2>
    </div>
    <div class="row g-4 justify-content-center">
        <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
            <div class="package-item">
                ...
                <div class="text-center">
                    <h4 class="mb-0 p-3">7 Nights Economy Umrah Deal</h4>
                    ...
                    <div class="row p-2">
                        ...
                        <p class="textlef"> <small><i class="fa fa-plane text-primary"></i></small> <span
                                ...
                                class="me-2">Transport</span> <small><i
                                    class="fa fa-id-card text-primary "></i></small> <span class="me-2">Visa</span>
                            <small><i class="fa fa-hotel text-primary"></i></small> <span class="me-2">Hotel</span>
                        </p>
        ...
        <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
            <div class="package-item">
                ...
                <div class="text-center">
                    <h4 class="mb-0 p-3">10 Nights Cheapest Umrah Deal</h4>
                    <span class="fa fa-star starpack"></span>
                    <span class="fa fa-star starpack"></span>
                    <span class="fa fa-star starpack"></span>
                    <span class="fa fa-star starpack"></span>
        ...
        <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
            <div class="package-item">
                ...
                <div class="text-center">
                    <h4 class="mb-0 p-3">10 Nights 4 Star Umrah Deal</h4>
                    <span class="fa fa-star starpack"></span>
                    <span class="fa fa-star starpack"></span>
                    <span class="fa fa-star starpack"></span>
                    <span class="fa fa-star starpack"></span>
        ...
        <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
            <div class="package-item">
                ...
                <div class="text-center">
                    <h4 class="mb-0 p-3">Special 12 Nights Family Umrah Deal</h4>
                    <span class="fa fa-star starpack"></span>
                    <span class="fa fa-star starpack"></span>
                    <span class="fa fa-star starpack"></span>
                    <span class="fa fa-star starpack"></span>
        ...
        <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
            <div class="package-item">
                ...
                <div class="text-center">
                    <h4 class="mb-0 p-3">10 Nights 5 Star <br>
                        Umrah Deal </h4>
                    <span class="fa fa-star starpack"></span>
                    <span class="fa fa-star starpack"></span>
                    <span class="fa fa-star starpack"></span>
        ...
        <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
            <div class="package-item">
                ...
                <div class="text-center">
                    <h4 class="mb-0 p-3">12 Nights Umrah with Clock Tower Hotel</h4>
                    <span class="fa fa-star starpack"></span>
                    <span class="fa fa-star starpack"></span>
                    <span class="fa fa-star starpack"></span>
                    <span class="fa fa-star starpack"></span>
        ...
        <div class="text-center wow fadeInUp mt-5" data-wow-delay="0.1s">
            <h6 class="text-center text-primary px-3">All-Inclusive</h6>
            <h2 class="deals">December Umrah Details</h2>
        </div>
        ...
        <div class="text-center wow fadeInUp mt-5" data-wow-delay="0.1s">
            <h6 class="text-center text-primary px-3">All-Inclusive</h6>
            <h2 class=" deals">Ramadan Umrah Details</h2>
        </div>
        ...
        <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
            <div class="package-item">
                ...
                <div class="text-center">
                    <h4 class="mb-0 p-3">7 Nights 3 Star Ramadan Umrah Package</h4>
                    <span class="fa fa-star starpack"></span>
                    <span class="fa fa-star starpack"></span>
                    <span class="fa fa-star starpack"></span>
                    <span class="fa fa-star checked"></span>
        ...
        <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
            <div class="package-item">
                ...
                <div class="text-center">
                    <h4 class="mb-0 p-3">7 Nights 4 Star Ramadan Umrah Package</h4>
                    <span class="fa fa-star starpack"></span>
                    <span class="fa fa-star starpack"></span>
                    <span class="fa fa-star starpack"></span>
                    <span class="fa fa-star starpack"></span>
        ...
        <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
            <div class="package-item">
                ...
                <div class="text-center">
                    <h4 class="mb-0 p-3">7 Nights 5 Star Ramadan Umrah Package</h4>
                    <span class="fa fa-star starpack"></span>
                    <span class="fa fa-star starpack"></span>
                    <span class="fa fa-star starpack"></span>
                    <span class="fa fa-star starpack"></span>
        ...
        <div class="text-center wow fadeInUp mt-5" data-wow-delay="0.1s">
            <h6 class="text-center text-primary px-3">All-Inclusive</h6>
            <h2 class=" deals">Easter Umrah Details</h2>
        </div>
        ...
        <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
            <div class="package-item">
                ...
                <div class="text-center">
                    <h4 class="mb-0 p-3">7 Nights 3 Star Easter Umrah</h4>
                    <span class="fa fa-star starpack"></span>
                    <span class="fa fa-star starpack"></span>
                    <span class="fa fa-star starpack"></span>
                    <span class="fa fa-star checked"></span>
        ...
        <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
            <div class="package-item">
                ...
                <div class="text-center">
                    <h4 class="mb-0 p-3">14 Nights 3 Star Easter Umrah</h4>
                    <span class="fa fa-star starpack"></span>
                    <span class="fa fa-star starpack"></span>
                    <span class="fa fa-star starpack"></span>
                    <span class="fa fa-star checked"></span>
        ...
        <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
            <div class="package-item">
                ...
                <div class="text-center">
                    <h4 class="mb-0 p-3">7 Nights 4 Star Easter Umrah</h4>
                    <span class="fa fa-star starpack"></span>
                    <span class="fa fa-star starpack"></span>
                    <span class="fa fa-star starpack"></span>
                    <span class="fa fa-star starpack"></span>
        ...
        <div class="text-center wow fadeInUp mt-5" data-wow-delay="0.1s">
            <h6 class="text-center text-primary px-3">All-Inclusive</h6>
            <h2 class=" deals">Umrah 2026 Details</h2>
        </div>
        ...
        <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
            <div class="package-item">
                ...
                <div class="text-center">
                    <h4 class="mb-0 p-3">7 Nights 3 Star Umrah 2026</h4>
                    <span class="fa fa-star starpack"></span>
                    <span class="fa fa-star starpack"></span>
                    <span class="fa fa-star starpack"></span>
                    <span class="fa fa-star checked"></span>
        ...
        <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
            <div class="package-item">
                ...
                <div class="text-center">
                    <h4 class="mb-0 p-3">10 Nights 3 Star Umrah 2026</h4>
                    <span class="fa fa-star starpack"></span>
                    <span class="fa fa-star starpack"></span>
                    <span class="fa fa-star starpack"></span>
                    <span class="fa fa-star checked"></span>
        ...
        <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
            <div class="package-item">
                ...
                <div class="text-center">
                    <h4 class="mb-0 p-3">14 Nights 3 Star Umrah 2026</h4>
                    <span class="fa fa-star starpack"></span>
                    <span class="fa fa-star starpack"></span>
                    <span class="fa fa-star starpack"></span>
                    <span class="fa fa-star checked"></span>
