                    ...
                    <div class="col-md-6 bg-dark p-4 mb-5 formheight" style="border-radius: 26px;">
                        ...
                        <form id="frm-enquiry" name="frm-enquiry" method="post" onsubmit="return false;">
                            <div class="row formfield">
                                ...
                                <div class="col-md-6 mb-2">
                                    <input type="text" id="enquiry-departuredate" name="enquiry-departuredate" class="datetimepicker form-select" placeholder="Departure Date" />
                                </div>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <button class="btn btn btn-primary py-2 px-4 w-100 py-3" type="button" value="submit1" id="btn-enquiry">Get Best Price</button>
                                </div>
