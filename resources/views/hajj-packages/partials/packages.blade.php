<div class="container-xxl motiff">
            <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
                <h6 class="text-center text-primary">Best</h6>
                <h1 class="mb-5 deals">Shifting & Non Shifting Hajj Packages</h1>
            </div>
            ...
            <div class="row g-4 justify-content-center">
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="package-item">
                        ...
                        <div class="text-center">
                            <h4 class="mb-0 p-3">4 Weeks Hajj Package (Non Shifting)</h4>
                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="package-item">
                        ...
                        <div class="text-center">
                            <h4 class="mb-0 p-3">2-3 Weeks Hajj Package (Non Shifting)</h4>
                                <span class="fa fa-star starpack"></span>
                                <span class="fa fa-star starpack"></span>
                                <span class="fa fa-star starpack"></span>
                                <span class="fa fa-star starpack"></span>
                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="package-item">
                        ...
                        <div class="text-center">
                            <h4 class="mb-0 p-3">2-3 Weeks Non Shifting Hajj Package</h4>
                                <span class="fa fa-star starpack"></span>
                                <span class="fa fa-star starpack"></span>
                                <span class="fa fa-star starpack"></span>
                                <span class="fa fa-star starpack"></span>
                ...
                <div class="text-center wow fadeInUp heading" data-wow-delay="0.1s"  ">
                    <h6 class="text-center text-primary px-3">All-Inclusive</h6>
                    <h2 class=" Best deals ">Best 3 Star Hajj Packages</h2>
                </div>
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="package-item">
                        <div class="overflow-hidden">
                        ...
                        <div class="text-center">
                            <h4 class="mb-0 p-3">7 Nights 3 Star hajj</h4>
                                <span class="fa fa-star starpack"></span>
                                <span class="fa fa-star starpack"></span>
                                <span class="fa fa-star starpack"></span>
                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="package-item">
                        ...
                        <div class="text-center">
                            <h4 class="mb-0 p-3">10 Nights 3 Star hajj</h4>
                                <span class="fa fa-star starpack"></span>
                                <span class="fa fa-star starpack"></span>
                                <span class="fa fa-star starpack"></span>
                                <span class="fa fa-star checked"></span>
                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="package-item">
                        ...
                        <div class="text-center">
                            <h4 class="mb-0 p-3">14 Nights 3 Star hajj</h4>
                                <span class="fa fa-star starpack"></span>
                                <span class="fa fa-star starpack"></span>
                                <span class="fa fa-star starpack"></span>
                                <span class="fa fa-star checked"></span>
                 ...
                 <div class="text-center wow fadeInUp heading" data-wow-delay="0.1s">
                    <h6 class="text-center text-primary px-3">All-Inclusive</h6>
                    <h2 class=" Best deals ">Best 4 Star Hajj Packages</h2>
                </div>
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="package-item">
                        <div class="overflow-hidden">
                        ...
                        <div class="text-center">
                            <h4 class="mb-0 p-3">5 Nights 4 Star hajj</h4>
                                <span class="fa fa-star starpack"></span>
                                <span class="fa fa-star starpack"></span>
                                <span class="fa fa-star starpack"></span>
                                <span class="fa fa-star starpack"></span>
                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="package-item">
                        ...
                        <div class="text-center">
                            <h4 class="mb-0 p-3">5 Star Hajj Package (non-shifting)</h4>
                                <span class="fa fa-star starpack"></span>
                                <span class="fa fa-star starpack"></span>
                                <span class="fa fa-star starpack"></span>
                                <span class="fa fa-star starpack"></span>
                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="package-item">
                        ...
                        <div class="text-center">
                            <h4 class="mb-0 p-3">10 Nights 4 Star Hajj</h4>
                                <span class="fa fa-star starpack"></span>
                                <span class="fa fa-star starpack"></span>
                                <span class="fa fa-star starpack"></span>
                                <span class="fa fa-star starpack"></span>
                 ...
                 <div class="text-center wow fadeInUp heading" data-wow-delay="0.1s">
                    <h6 class="text-center text-primary px-3">All-Inclusive</h6>
                    <h2 class="Best deals ">Best 5 Star Hajj Packages</h2>
                </div>
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="package-item">
                        <div class="overflow-hidden">
                        ...
                        <div class="text-center">
                            <h4 class="mb-0 p-3">7 Nights 5 Star Hajj</h4>
                                <span class="fa fa-star starpack"></span>
                                <span class="fa fa-star starpack"></span>
                                <span class="fa fa-star starpack"></span>
                                <span class="fa fa-star starpack"></span>
                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="package-item">
                        ...
                        <div class="text-center">
                            <h4 class="mb-0 p-3">12 Nights 5 Star Hajj</h4>
                                <span class="fa fa-star starpack"></span>
                                <span class="fa fa-star starpack"></span>
                                <span class="fa fa-star starpack"></span>
                                <span class="fa fa-star starpack"></span>
                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="package-item">
                        ...
                        <div class="text-center">
                            <h4 class="mb-0 p-3">14 Nights 5 Star Hajj</h4>
                                <span class="fa fa-star starpack"></span>
                                <span class="fa fa-star starpack"></span>
                                <span class="fa fa-star starpack"></span>
                                <span class="fa fa-star starpack"></span>
