<div class="container-fluid hero-header" style="min-height: 627px;">
    <div class="container">
        <div class="row justify-content-center">
            <div class="container-fluid  g-4" data-wow-delay="0.1s">
                <div class="row align-items-center">
                    <div class="col-md-6 bg-white">
                    </div>
                    <div class="col-md-6 bg-dark p-4 mb-5 formheight" style="border-radius: 26px;">
                        ...
                        <form id="frm-enquiry" name="frm-enquiry" method="post" onsubmit="return false;">
                            <div class="row formfield">
                                ...
                                <div class="col-md-6 mb-2">
                                    <input type="text" id="enquiry-departuredate" name="enquiry-departuredate"
                            ...
                            <div class="row formfield">
                                ...
                                <div class="col-md-6 mb-2">
                                    <input type="text" class="form-select form-control" id="enquiry-name"
                                        name="enquiry-name" placeholder="Full Name">
                                </div>
                            </div>
                            ...
                            <div class="row formfield">
                                <div class="col-md-6 mb-2">
                                    <input type="text" class="form-select  form-control" id="enquiry-phone"
                                        name="enquiry-phone" placeholder="Contact No">
                                </div>
                                <div class="col-md-6 mb-3">
                                    <input type="email" class="form-select form-control" name="enquiry-email"
                                        id="enquiry-email" placeholder="Email">
                                </div>
                                <div class='font-weight-300 text-white fs-16' id="msg10"></div>
                                <div class='font-weight-300 text-white fs-16' id="msg11"></div>
                            </div>
                            <div class="row">
                                <div class="col-md-12">
                                    <button class="btn btn btn-primary py-2 px-4 w-100 py-3" type="button"
                                        value="submit1" id="btn-enquiry">Get Best Price</button>
                                </div>
                                <div class='font-weight-300 text-white fs-16' id="enquiry-success-msg1"></div>
                            </div>
                        </form>
                    </div>
                </div>
